...
//  HelloWatchOS
//
//  Created by Azmi Muhammad on 19/08/19.
...
// 1: Encapsulating in a tuple for not duplicating code
...
class WSManager: NSObject {
    ...
    static let shared: WSManager = WSManager()
...
extension WSManager: WCSessionDelegate {
