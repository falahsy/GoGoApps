...
//        collectionView.delegate = self
        ...
        collectionView.register(UINib(nibName: "FriendsCell", bundle: nil), forCellWithReuseIdentifier: "FriendsCell")
    ...
    func showInputDialog() {
        ...
        let confirmAction = UIAlertAction(title: "Submit", style: .default) { (_) in
            ...
            let activity = Activity(id: self.activityID!.trimmingCharacters(in: .whitespacesAndNewlines), routes: routesShared,date:Date(), adminID:self.userID!)
    ...
    @IBAction func searchActivity(_ sender: UIButton) {
        ...
        if isSearchActivityClicked{
            ...
            searchActivity.setTitle("Activity", for: .normal)
            ...
            let activitySearchTable = SearchActivityVC()
            ...
            activitySearchTable.delegate = self
            cancelRoutes()
        }
...
extension MapVC: SearchRouteDelegate {
